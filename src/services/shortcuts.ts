...
export const SHORTCUTS: ShortcutItem[] = [
  ...
  { id: 'settings', key: 'Ctrl+I', label: '打开设置', category: '导航' },
  { id: 'toggle-sidebar', key: 'Ctrl+B', label: '切换侧边栏', category: '视图' },
  { id: 'toggle-ai', key: 'Ctrl+J', label: '切换 AI 面板', category: '视图' },
  { id: 'toggle-theme', key: 'Ctrl+Shift+L', label: '切换深浅主题', category: '视图' },
  { id: 'toggle-fullscreen', key: 'F11', label: '切换全屏模式', category: '视图' },
